# Intro to Computer Vision - ARTTECH 3039
## Spring 2021 (February 2 - May 11)

#### **Meetings**
Tuesdays | 9:30am-12:30pm CST *~break~* 2:00pm-5:00pm

#### **Instructor**
Doug Rosman | drosman@saic.edu | [dougrosman.com](https://dougrosman.com)
...
* Class Canvas Page: [https://saic.instructure.com/courses/3134664](https://saic.instructure.com/courses/3134664). Please enable email notifications for Canvas announcements

#### **Slack Channel**
Much of our in-class and out-of-class communication will take place in a dedicated Slack channel.
* Join the channel: [CVML Slack Channel Invite Link (only use this once)](https://join.slack.com/t/cvmlsaic-sp21/shared_invite/zt-kzu1o4vp-Zry5GBpQWjBa9IBKDjZ04Q) (this invite link expires on February 16)
* Visit the channel: [cvmlsaic-sp21.slack.com](cvmlsaic-sp21.slack.com)
...
In this course, we engage the field of computer vision as both a fertile territory for artistic experimentation, and as a complex subject for critical interrogation. Through technical demonstrations and project-based experimentation, this course will introduce a variety of tools for creating interactive art and machine learning-based generative imagery. Throughout the semester, we will confront the ethical implications of computer vision technologies both as artists creating with these tools, and as citizens in a world where these technologies are ubiquitous, powerful, and often harmful.
...
* [Decision-Making, Delegated, Art-Making: AI and Art, A.D. 2019](https://flatjournal.com/work/decision-making-delegated-art-making-ai-and-art-a-d-2019/) - Mira C, 2019

#### *Excerpts from*
* [Race After Technology](https://www.ruhabenjamin.com/race-after-technology) - Ruha Benjamin, 2019
* [Algorithms of Opression: How Search Engines Reinforce Racism](https://nyupress.org/9781479837243/algorithms-of-oppression/) - Safiya Umoja Noble, 2018
* [The Age of Surveillance Capitalism](https://www.google.com/books/edition/The_Age_of_Surveillance_Capitalism/lRqrDQAAQBAJ?hl=en&gbpv=1&dq=the+age+of+surveillance+capitalism) - Shoshana Zuboff, 2019
...
## Attendance
SAIC policy states that students are expected to attend all classes regularly and on time. Students should miss class only with reasonable cause. If a student needs to miss class with reasonable cause, it is the student’s responsibility to contact the instructor to receive instruction for how to make up for the missed class. It is the instructor’s responsibility to give this information to the student as his/her/their schedule permits. Missing class for other than a reasonable cause may jeopardize the student’s academic standing in the class. Attendance is required on the final critique day to receive credit for this course.

1. If a student misses MORE than 3 sections, whether or not for a reasonable cause, the student will fail the class, if the student does not withdraw from the class prior to the deadline for withdrawal with a grade of "W."
2. Two late arrivals will count as a missed section. Arriving more than 30 minutes late to class will count as an absence

**Deadline for withdrawal:** Wednesday, March 31, 2021
...
**Email:** writingcenter@saic.edu
**Phone:** 312.499.4138
**Writing Center Web Page:** [http://www.saic.edu/academics/academicresources/writingcenter/](http://www.saic.edu/academics/academicresources/writingcenter/)
...
## ATS Facilities
Normal ATS facilities access, procedures and policies have changed significantly in response to COVID-19 pandemic. Please familiarize yourself with ATS facilities availability, capacity, authorizations, reservations, sanitation and other ATS-specific information in the ATS Facilities Canvas Course.

## ATS Community
ATS is working to build a strong online and offline community during the COVID-19 pandemic. We strongly encourage all ATS students to sign up for our departmental forum at https://ats.community. Students can find out about visiting artist opportunities, upcoming ATS Town Halls, our Diversity, Equity and Inclusion reading group, special events, participate in discussions, and get help with their projects.
